...
function carregarDicasPorCep(cep) {
  ...
  // Apenas como exemplo: CEPs de Maringá geralmente começam com 870
  if (/^870/.test(cep)) {
    container.innerHTML = `
      <h2>Recicle em Maringá!</h2>
      <p>📍 Pontos de coleta seletiva próximos: <a href="https://www.maringa.pr.gov.br" target="_blank">confira aqui</a>.</p>
      <p>🟢 Vidro: leve em ecopontos autorizados. A quebra dificulta o processo de triagem.</p>
      <p>🟡 Plásticos e metais: separe limpos e secos.</p>
      <p>🔵 Papel: evite papel engordurado ou contaminado.</p>
      <p>♻️ Dica: a coleta seletiva em Maringá ocorre de segunda a sexta em bairros distintos.</p>
    `;
  } else {
    // Se não for Maringá, mantém as dicas padrão
    container.innerHTML = `
      <h2>Por um planeta mais limpo!</h2>
      <p>Você sabia que uma garrafa plástica pode levar até 450 anos para se decompor?</p>
      <p>Separe seu lixo e ajude a reduzir a poluição!</p>
      <p>Cada pequena ação conta. Vamos juntos preservar o meio ambiente!</p>
    `;
  }
}
